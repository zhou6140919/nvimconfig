...
_G.packer_plugins = {
  ...
  ["lualine-lsp-progress"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/lualine-lsp-progress",
  ...
  ["telescope-env.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/telescope-env.nvim",
  ...
  transparent = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/transparent",
